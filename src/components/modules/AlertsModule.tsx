...
const alertTypeColors = {
  'annuity_deadline': 'bg-red-100 text-red-800 border-red-200',
  'agreement_expiry': 'bg-amber-100 text-amber-800 border-amber-200',
  'office_action': 'bg-blue-100 text-blue-800 border-blue-200',
...
const alertTypeIcons = {
  'annuity_deadline': AlertTriangle,
...
export function AlertsModule() {
  ...
  const generateSampleAlerts = useCallback(async () => {
    const sampleAlerts = [
      {
        type: 'annuity_deadline',
        title: 'Patent Annuity Due Soon',
        description: 'Patent US10,123,456 annuity payment due in 15 days',
        entity_type: 'filing',
        entity_id: 'filing_1',
      ...
      },
      {
        ...
        description: 'Response required for Application 17/234,567 within 60 days',
        entity_type: 'filing',
        entity_id: 'filing_2',
      ...
      },
      {
        ...
        description: 'Patent search completion due for Project Alpha',
        entity_type: 'project',
        entity_id: 'project_1',
          ...
          <div className="flex gap-2">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="annuity_deadline">Annuities</SelectItem>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        <h4 className="font-medium">Annuity Deadlines</h4>
                        <p className="text-sm text-gray-600">Get notified about upcoming patent annuity payments</p>
                      </div>
                      <div className="flex gap-2">
