...
import { useLinking, useDisclosures, useFilings, useProjects, useAgreements, useStartups } from '@/hooks/useData'
...
export function CrossLinkingPanel({ entityType, entityId, entityTitle }: CrossLinkingPanelProps) {
  ...
  const getAvailableEntities = () => {
    ...
    return allEntities.filter(entity => 
      ...
      (selectedEntityType === '' || entity.type === selectedEntityType) &&
      (searchTerm === '' || 
  ...
  const getEntityDetails = (entityType: string, entityId: string) => {
    ...
    switch (entityType) {
      case 'disclosure':
        ...
        break
      case 'filing':
        entity = filings.find(f => f.id === entityId)
        break
      case 'project':
